...
export class MoviesListComponent implements OnInit, OnDestroy{
  ...
  ngOnInit(){
      if(this.service.isLoggedIn() == "N"){
        ...
        if(this._activatedRoute.snapshot.paramMap.get("genreName") != null){
          ...
          // this.dataSource.paginator = this.paginator;
        ...
        else if(this._activatedRoute.snapshot.queryParams.title != undefined || this._activatedRoute.snapshot.queryParams.search_bar != undefined) {
            ...
            if(!('search_bar' in this.searchData)){
            ...
            this.service.getFullSearchResults(this.searchData);
